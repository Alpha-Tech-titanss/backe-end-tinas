...
@ObjectType()
export class JwajemShop extends Document {
  @Field(() => String)
  _id;
  ...
  @Prop({ type: String, enum: CommerceType, default: CommerceType.JwajemShop })
  ObjecType;
}

export const JwajemShopSchema = SchemaFactory.createForClass(JwajemShop);
