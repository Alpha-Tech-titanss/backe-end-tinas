    ...
    common_1.Module({
        imports: [
            ...
            graphql_1.GraphQLModule.forRoot({
                ...
                formatError: (err) => ({ message: err.message, status: err.status || 500 }),
                uploads: {
...
const activation_guard_1 = __webpack_require__(/*! src/utils/guards/activation.guard */ "./src/utils/guards/activation.guard.ts");
...
__decorate([
    common_1.UseGuards(activation_guard_1.ActivateAuthGuard),
    graphql_1.Mutation(() => graphql_1.Int),
    __param(0, current_user_decorator_1.CurrentUser()),
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ApplyAccessCodeInput = exports.CreateAccessCodeInput = exports.PlaceInput = exports.PlaceGalleryInput = exports.AddPlaceInput = exports.BundleInput = exports.ChapterInput = exports.AddChapterInput = exports.TripInput = exports.PostionInput = void 0;
const graphql_1 = __webpack_require__(/*! @nestjs/graphql */ "@nestjs/graphql");
...
__decorate([
    graphql_1.Field(() => Boolean, { description: 'An optional field to mark trip as special', nullable: true }),
    __metadata("design:type", Boolean)
...
__decorate([
    ...
    graphql_1.Mutation(() => trip_entity_1.Trip),
    __param(0, graphql_1.Args('id', { type: () => String })), __param(1, graphql_1.Args('placeGalleryInput')),
    __metadata("design:type", Function),
...
TripResolver = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_h = typeof trip_service_1.TripService !== "undefined" && trip_service_1.TripService) === "function" ? _h : Object])
], TripResolver);
...
let TripService = class TripService {
    constructor(TripModel, ChapterModel, PlaceModel, AccessCodeModel, bundleService, userService) {
    ...
    findAll() {
        return this.TripModel.find().populate({ path: "chapters", populate: { path: "places" } });
    }
    async findOne(id, user = null) {
        const trip = await this.TripModel.findById(id).populate({ path: "chapters", populate: { path: "places", populate: { path: 'bundle' } } });
        if (!user) {
            return trip;
        }
        if (trip.isSpecial) {
    ...
    findOneChapter(id) {
        return this.ChapterModel.findById(id).populate({ path: "places", populate: { path: 'bundle' } });
    }
    findOnePlace(id) {
    ...
    chapterFromPlace(id) {
        return this.ChapterModel.findOne({ places: { $in: [id] } }).populate({ path: 'places', populate: { path: 'bundle' } });
    }
    ...
    async createAccessCode(createTripAcessCodeInput) {
        ...
        const accessCode = await (new this.AccessCodeModel({ code, tripId: trip._id })).save();
        return await this.AccessCodeModel.findById(accessCode.id);
    }
    async applyTripAccessCode(applyAccessCodeInput, user) {
        const found = await this.AccessCodeModel.find({ tripId: mongoose_2.Types.ObjectId(applyAccessCodeInput.id), code: applyAccessCodeInput.code });
        if (found.length) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.UserSchema = exports.User = exports.Message = void 0;
const graphql_1 = __webpack_require__(/*! @nestjs/graphql */ "@nestjs/graphql");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const mongoose_2 = __webpack_require__(/*! mongoose */ "mongoose");
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], UserResolver.prototype, "updateDefaultTrip", null);
...
let UserService = class UserService {
    ...
    async init() {
        this.transporter = nodemailer.createTransport({
            ...
            secure: false,
            auth: {
                user: "linwood.stark@ethereal.email",
                pass: "JgYbcz8HHeSqNbRYpJ",
            },
        });
    }
    ...
    async updateDefaultTrip(userId, tripId) {
        const user = await this.UserModel.findById(userId);
        await user.update({ selectedTrip: mongoose_2.Types.ObjectId(tripId) });
        return user;
    }
};
...
/***/ "./src/utils/guards/activation.guard.ts":
/*!**********************************************!*\
  !*** ./src/utils/guards/activation.guard.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ActivateAuthGuard = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const graphql_1 = __webpack_require__(/*! @nestjs/graphql */ "@nestjs/graphql");
const passport_1 = __webpack_require__(/*! @nestjs/passport */ "@nestjs/passport");
const public_decorator_1 = __webpack_require__(/*! ./public.decorator */ "./src/utils/guards/public.decorator.ts");
let ActivateAuthGuard = class ActivateAuthGuard extends passport_1.AuthGuard("jwt") {
...
ActivateAuthGuard = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof core_1.Reflector !== "undefined" && core_1.Reflector) === "function" ? _a : Object])
], ActivateAuthGuard);
exports.ActivateAuthGuard = ActivateAuthGuard;
...
let GqlAuthGuard = class GqlAuthGuard extends passport_1.AuthGuard("jwt") {
    ...
    handleRequest(err, user, info) {
        if (err || !user || user.banned || !user.emailConfirmation) {
            throw err || new common_1.UnauthorizedException();
        }
        return user;
    }
