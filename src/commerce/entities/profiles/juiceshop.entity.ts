...
@ObjectType()
export class JuiceShop extends Document {
  @Field(() => String)
  _id;
  ...
  @Prop({ type: String, enum: CommerceType, default: CommerceType.JuiceShop })
  ObjecType;
}

export const JuiceShopSchema = SchemaFactory.createForClass(JuiceShop);
